 ...
 */
class ExtConfigurationClassParser2 {
     ...
     */
    public ExtConfigurationClassParser2(MetadataReaderFactory metadataReaderFactory,
    ...
    private class DeferredImportSelectorGroupingHandler {
        ...
        private Group createGroup(@Nullable Class<? extends Group> type) {
            ...
            Group group = ParserStrategyUtils.instantiateClass(effectiveType, Group.class,
                    ExtConfigurationClassParser2.this.environment,
                    ExtConfigurationClassParser2.this.resourceLoader,
                    ExtConfigurationClassParser2.this.registry);
            return group;
        }
